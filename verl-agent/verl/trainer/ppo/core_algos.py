...
def compute_grpo_outcome_advantage(
    ...
    Args:
        ...
        compute_mean_std_cross_all_data: bool
            If True (more stable), the mean and std are computed across all steps within one group.
            If False (i.e., standard episode-level adv), the mean and std are computed across
            trajectories within one group (one score per trajectory, deduped by traj_index).
